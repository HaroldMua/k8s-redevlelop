/*
refer to:
https://github.com/kubernetes/client-go/blob/master/examples/create-update-delete-deployment/main.go#L113
 */
...
func main() {
	...
	retryErr := retry.RetryOnConflict(retry.DefaultRetry, func() error {   // 匿名函数作为参数
